...
/*#__PURE__*/
function () {
  function RevealOnScroll(itemsToReveal, offset) {
...
function () {
  function StickyHeader() {
    ...
    this.siteHeader = jquery__WEBPACK_IMPORTED_MODULE_0___default()(".site-header");
    this.headerTriggerElement = jquery__WEBPACK_IMPORTED_MODULE_0___default()(".headline");
    ...
    value: function createPageSectionWaypoint() {
      this.pageSections.each(function () {
        ...
        new Waypoint({
          element: currentItem,
          handler: function handler(direction) {
            var matchingSectionLink = currentItem.getAttribute("data-matching-link");

            if (direction === "down") {
              jquery__WEBPACK_IMPORTED_MODULE_0___default()(matchingSectionLink).parent().siblings().each(function () {
                jquery__WEBPACK_IMPORTED_MODULE_0___default()(this.children[0]).removeClass("is-current-link");
              });
              jquery__WEBPACK_IMPORTED_MODULE_0___default()(matchingSectionLink).addClass("is-current-link");
            }
          },
